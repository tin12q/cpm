...
const {getTeams, getTeamWithId, userInTeam, addTeam, getTeamByName, getTeamByProjectId} = require('../controller/TeamController');


router.get('/team/:id', authenticate, requireRole({collection: 3, task: 0}), getTeamByProjectId);
router.get('/name/:name', authenticate, requireRole({collection: 3, task: 0}), getTeamByName);
