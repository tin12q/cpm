...
const { getUser, getUsers, addUser, deleteUser, updateUser, findByName, getMe } = require('../controller/UserController');
...
router.get('/me', authenticate, requireRole({ collection: 2, task: 0 }), getMe);
