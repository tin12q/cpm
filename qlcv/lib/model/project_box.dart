              ...
              children: [
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () async {
                      // Get first team name (for backward compatibility with currentDepName)
                                ...
                                return AlertDialog(
                                  ...
                                  actions: <Widget>[
                                    ...
                                    TextButton(
                                      ...
                                      onPressed: () {
                                        deleteproject(
                                            project); // Calls the deleteproject function
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, index) {
        if (index >= 0 && index < projects.length) {
          ...
          print(
              'Index $index is out of range for list of length ${projects.length}');
